...
class CfgWeapons 
{
    ...
    class sfp_ak5_base : Rifle_Base_F 
    {
        ...
        class Single: Mode_SemiAuto
        {
            ...
            {
                soundSetShot[] = {"jsrs_rifle_shake_soundset", "jsrs_m4_shot_soundset", "jsrs_spar_shell_soundset", "jsrs_5x56mm_reflector_1", "jsrs_556mm_echo_soundset"};
            };
            class SilencedSound: BaseSoundModeType
            {
                soundSetShot[] = {"jsrs_rifle_shake_soundset", "jsrs_m4_shot_silenced_soundset", "jsrs_spar_shell_soundset", "jsrs_5x56mm_sd_reflector_1"};
            };
        };
