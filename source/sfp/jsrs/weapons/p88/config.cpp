...
class CfgWeapons 
{
    ...
    {
        drysound[] = {"\jsrs_soundmod\jsrs_soundmod_snd_weapons\sounds\dry\p07_dry.ogg", 1.5, 1, 15};
        reloadmagazinesound[] = {"\jsrs_soundmod\jsrs_soundmod_snd_weapons\sounds\reload\p07_reload.ogg", 2, 1, 35};
        ...
        class Single: Mode_SemiAuto
        {
            ...
            {
                soundSetShot[] = {"jsrs_pistol_shake_soundset", "jsrs_rook40_shot_soundset", "jsrs_p07_shell_soundset", "jsrs_9mm_reflector_1", "jsrs_small_echo_soundset"};
            };
            class SilencedSound: BaseSoundModeType
            {
                soundSetShot[] = {"jsrs_pistol_shake_soundset", "jsrs_p07_shot_silenced_soundset", "jsrs_p07_shell_soundset", "jsrs_9mm_sd_reflector_1"};
            };
        };
    };
};
