...
class CfgWeapons 
{
    ...
    class sfp_ksp90b: Rifle_Long_Base_F
    {
        ...
        class manual: Mode_FullAuto
        {
            ...
            {
                soundSetShot[] = {"jsrs_rifle_shake_soundset", "jsrs_mk200_shot_soundset", "jsrs_6x5mm_reflector_1", "jsrs_mg_echo_soundset"};
            };
            class SilencedSound: BaseSoundModeType
            {
                soundSetShot[] = {"jsrs_rifle_shake_soundset", "jsrs_mk200_shot_silenced_soundset", "jsrs_6x5mm_sd_reflector_1"};
            };
        };
    };
};
