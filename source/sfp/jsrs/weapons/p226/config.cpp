class CfgPatches {
    class sfp_jsrs_weapons_p226 {
        ...
        weapons[] = {};
        requiredVersion = 1.0;
        requiredAddons[] = {"sfp_p226", "jsrs_soundmod_complete_edition"};
...
class CfgWeapons 
{
    ...
    class sfp_p226: Pistol_Base_F
    {
        ...
        class Single: Mode_SemiAuto
        {
            ...
            {
                soundSetShot[] = {"jsrs_p226_shot_soundset", "jsrs_9mm_reverb_soundset"};
            };
            class SilencedSound: BaseSoundModeType
            {
                soundSetShot[] = {"jsrs_p226_shot_silenced_soundset", "jsrs_9mm_sd_reverb_soundset"};
            };
        };
    };
};
